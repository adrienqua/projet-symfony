 ...
 */
final class Version20250208233958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD cover_picture VARCHAR(255) DEFAULT NULL, CHANGE score score INT DEFAULT 0 NOT NULL');
    ...
    {
        $this->addSql('ALTER TABLE offer DROP cover_picture, CHANGE score score INT NOT NULL');
